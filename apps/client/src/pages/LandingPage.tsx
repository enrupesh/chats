...
function VerifiedByOpenSource() {
  ...
  const proofCards: ProofCardDef[] = [
    ...
    },
    {
      ...
      link: "https://github.com/loren-dasu/veilchat",
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-20">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-wrap gap-3 mt-1">
              ...
              <a
                href="https://github.com/loren-dasu/veilchat"
                target="_blank"
                rel="noopener noreferrer"
          ...
          >
            ...
            >
              ...
              <a
                href={`https://github.com/loren-dasu/veilchat/blob/main/apps/client/src/lib/${VO_CODE_TABS[tab]?.file}`}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            <div className="mt-5 flex items-center gap-2">
              <SocialIcon label="GitHub" href="https://github.com/loren-dasu">
          ...
          l.onClick ? (
            <li key={l.label}>
              <button
                type="button"
                onClick={l.onClick}
                className="text-[#FCF5EB]/80 hover:text-white transition-colors text-left"
              >
                {l.label}
              </button>
            </li>
